...
const LogIn = ({ closeModal, setLogMode }) => {
  ...
  return (
    <div className="w-full h-full relative bg-white rounded-md py-6 px-10 sm:py-8 sm:px-16 md:py-12 md:px-20 text-xs sm:text-sm 400:px-8 400:text-[10px]">
      ...
      <div className="flex items-center justify-center gap-2 font-bold w-full border-2 rounded-sm p-2 text-center cursor-pointer hover:bg-slate-100 duration-200">
        <img src={Logo} />
        Google ilə daxil olun
      </div>
      <h1 className="text-xl sm:text-2xl md:text-3xl font-bold p-4 sm:p-5 md:p-6 text-center">
        Xoş gəlmişsiniz
      </h1>
